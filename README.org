...
*** org-refile-headline
- *Description:* Move a headline and its entire subtree to become a child of a different parent headline
- *Parameters:*
  - =sourceUri= (string, required): URI of the headline to move (supports =org-headline://= or =org-id://=)
  - =targetParentUri= (string, required): URI of the new parent headline where the source will be moved as a child (supports =org-headline://= or =org-id://=)
- *Returns:* Success status with ID-based URI of the moved headline
- *Behavior:*
  ...
  - Creates Org ID for source headline if one doesn't exist

Example:
#+begin_src json
# Request:
{
  "sourceUri": "org-headline:///home/user/org/projects.org#Old%20Parent/Task%20to%20Move",
  "targetParentUri": "org-headline:///home/user/org/projects.org#New%20Parent"
}
...
# Error when trying to create cycle:
{
  "error": "Cannot refile headline under its own descendant"
}

# Cross-file refile example:
{
  "sourceUri": "org-id://abc-123",
  "targetParentUri": "org-headline:///home/user/org/archive.org#Completed%20Projects"
}
#+end_src
